                ...
                <div className="misc">
                  ...
                  <div className="rating" style={{ marginLeft: "2rem" }}>
                    ...
                    <span className="rating-stars">
                      {profileUser?.rating
                        ? Array.from({ length: Math.round(profileUser.rating) }, (_, index) => (
                            <span key={index}>⭐</span>
                          ))
                        : ""}
                    </span>
                    <span className="rating-value">{profileUser?.rating ? profileUser?.rating : "No ratings yet"}</span>
                  </div>
                    ...
                    user?.username !== username && (
                      <div className="buttons">
                        {profileUser?.status === "Connected" ? (
                          ...
                          <button className="connect-button">Pending</button>
                        ) : profileUser?.status === "Rejected" ? (
                          <button
